...
function setCanvas(canvas, planeParam, endPoint = "israel") {
    var width = 370,
        height = 370;
    ...
    var selectedCountryFill = "#007ea3",
        ...
        landFill = "#b9b5ad",
        seaFill = "#e9e4da";
    var startCountry = "antarctica";
    var endCountry = endPoint;
        ...
        function customTransition(journey) {
            ...
            d3.transition()
                ...
                .tween("rotate", function () {
                    ...
                    redraw();
                    d3.select(canvas).call(dragBehaviour);//////////////////////////////////////////////////////////////////
                })
        }
    ...
    queue()
        .defer(d3.json, 'http://127.0.0.1:5500/world-110m.json')
        .defer(d3.tsv, "http://127.0.0.1:5500/world-country-names.tsv")
        .await(ready);
